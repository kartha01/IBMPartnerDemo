...
- [Provision the Control plane or lite assembly](#provision-the-control-plane-or-lite-assembly-1)
- [Building the configuration](#building-the-configuration-1)
- [Review Services installed](#review-services-installed-1)
- [Set up Data Virtualization](#set-up-data-virtualization-1)
- [Set up Watson Studio or Watson Machine Learning](#set-up-watson-studio-or-watson-machine-learning-1)
  * [Increase the capacity or scale up your service](#increase-the-capacity-or-scale-up-your-service-1)
- [Set up Watson OpenScale](#set-up-watson-openscale-1)
- [Adding additional services](#adding-additional-services-1)
  * [To enable or disable the default admin users](#to-enable-or-disable-the-default-admin-users-1)
  * [How can I patch a service or control plane](#how-can-i-patch-a-service-or-control-plane-1)
- [Install Db2 Warehouse (SMP)](#install-db2-warehouse--smp--1)
  * [Provision a Database instance](#provision-a-database-instance-1)
  * [Create a Table](#create-a-table-1)
  * [Uninstalling DB2 Warehouse.](#uninstalling-db2-warehouse-1)
- [Installing DataStage service](#installing-datastage-service-1)
  * [Create a Transformation Project](#create-a-transformation-project-1)
  * [Uninstalling DataStage.](#uninstalling-datastage-1)
- [Installing Analytics Dashboards](#installing-analytics-dashboards-1)
- [Installing Analytics Engine (Spark Clusters)](#installing-analytics-engine--spark-clusters--1)
